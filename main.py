...
app.config['SQLALCHEMY_DATABASE_URI']='mysql://root:@localhost/hospitaldbms'
db=SQLAlchemy(app)
...
def patient():
    ...
    if request.method=="POST":
        ...
        #mail.send_message('HOSPITAL MANAGEMENT SYSTEM', sender=params['gmail-user'], recipients=[email],body="YOUR BOOKING IS CONFIRMED THANKS FOR CHOOSING US HAVE GOOD HEALTHY TIME")
